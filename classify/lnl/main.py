...
class Trainer(object):
    def __init__(self, args):
        ...
        self.kwargs = {'num_workers': 16, 'pin_memory': True}
        ...
        elif args.net == 'dual_stream_vit':
            from models.dual_stream_vit import DualStreamViT
            model = DualStreamViT(num_classes=self.args.num_class)
        else:
...
def main():
    ...
    parser.add_argument('--net', type=str, default='preresnet18',
                        choices=['resnet50', 'preresnet18', 'dual_stream_vit'],
                        help='net name (default: preresnet18)')
    parser.add_argument('--dataset', type=str, default='miniimagenet_preset', choices=['miniimagenet_preset', 'cifar100', 'web-brid', 'web-car', 'web-aircraft', 'ds_custom', 'ds_custom2', 'ds_custom3'])
